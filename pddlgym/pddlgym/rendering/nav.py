...
NUM_OBJECTS = 6
CLEAR, ROBOT, STONE, STONE_AT_GOAL, GOAL, WALL = range(NUM_OBJECTS)
...
def build_layout(obs):
    ...
    for v in get_values(obs, 'at-robot'):
        r, c = loc_str_to_loc(v[0])
        layout[r, c] = ROBOT
