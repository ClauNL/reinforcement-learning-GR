...
def build_layout_goals(obs, goals):
...
def render(obs, mode='human', close=False, goals=(0 , 0)):
    if mode == "egocentric":
    ...
    elif mode == "goals_layout":
        layout = build_layout_goals(obs, goals)
        return render_from_layout(layout, get_token_images)
